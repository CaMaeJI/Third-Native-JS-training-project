...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.parentNode.addEventListener('submit', function (e) {
      e.preventDefault();
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_services_request__WEBPACK_IMPORTED_MODULE_3__["getResourse"])('http://localhost:3000/styles').then(function (res) {
